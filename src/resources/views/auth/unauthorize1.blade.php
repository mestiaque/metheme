...
<div class="maincontainer">
  <div class="bat">
    <img class="wing leftwing"
         src="{{ asset('assets/img/default-img/hauntedHouse/bat-wing.png') }}">
    <img class="body"
         src="{{ asset('assets/img/default-img/hauntedHouse/bat-body.png') }}" alt="bat">
  ...
  <img class="foregroundimg" src="{{ asset('assets/img/default-img/hauntedHouse/HauntedHouseForeground.png') }}" alt="haunted house">
...
<div class="text-center back-btn">
    ...
    <a href="{{ $url }}" class="btn bg-encodex-secondary text-white">
...
<link href="https://fonts.googleapis.com/css2?family=Creepster&display=swap" rel="stylesheet">
    ...
    /* top: -150px; */
    transform: scale(0.8);
    background: url("{{ asset('assets/img/default-img/hauntedHouse/HauntedHouseBackground.png') }}") no-repeat center center;
