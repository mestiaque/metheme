    ...
    <div class="login-card glass-card">
        <div class="login-form">
            <div class="login-header mb-0">
                ...
                <p style="text-align: center; color:#ffffff7a" class="text-shadow">{{ __('me::me.Reset your password by verifying your account.') }}</p>
            </div>
            ...
            <form id="forgotPasswordForm" class="submitForm">
                ...
                <div class="text-center mt-3">
                    <p style="color:#ffffff7a" class="text-shadow">
                        {{ __('me::me.Remembered your password?') }} <a href="{{ route('login') }}" style="color: #fff; text-decoration: underline;">{{ __('me::me.Login') }}</a>
                    </p>
                </div>
            </form>
        </div>
