    ...
    <div class="login-card glass-card">
        <div class="login-form">
            <div class="login-header mb-0">
                ...
                <p style="text-align: center; color:#ffffff7a" class="text-shadow">{{ __('me::me.Create your account to get started.') }}</p>
            </div>
            ...
            <form id="registrationForm" class="submitForm">
                ...
                <div class="text-center my-4 d-none" style="color: #ffffff7a; position: relative;">
                    ...
                    <span style="position: absolute; top: -12px; background: #222; padding: 0 15px; left: 50%; transform: translateX(-50%);">{{ __('me::me.OR') }}</span>
                </div>
                ...
                <div class="text-center mt-3">
                    <p style="color:#ffffff7a" class="text-shadow">
                        {{ __('me::me.Already have an account?') }} <a href="{{ route('login') }}" style="color: #fff; text-decoration: underline;">{{ __('me::me.Login') }}</a>
                    </p>
                </div>
            </form>
